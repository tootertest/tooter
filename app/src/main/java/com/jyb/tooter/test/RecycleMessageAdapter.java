...
//
//public class RecycleMessageAdapter extends RecyclerView.Adapter<StatusHolder> {
//
//    FragmentMessage mFragment;
//    ArrayList<Status> mData;
//    View mView;
//
//    public RecycleMessageAdapter(FragmentMessage fragment) {
...
//        });
//
//        holder.setFavouriteSelecte(cStatus.favourited);
